...
class DocumentEditor{
    private:
      ...
      // Render the document by checking the type of each element at run time
...
int main(){
    ...
    editor.addText("This is Ankit Singh Rajput!");
    editor.addImage("ankits-profile-photo.png");
